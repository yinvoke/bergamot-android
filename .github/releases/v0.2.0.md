...
![v0.1.0 与 v0.2.0 的翻译耗时和峰值内存对比](https://github.com/yinvoke/bergamot-android/releases/download/v0.2.0/comparison.png)

[完整基准与复现方法](https://github.com/yinvoke/bergamot-android/blob/main/docs/benchmarks/v0.2.0/README.md)。上述数据为原生引擎测试,首次翻译含模型加载,不是 app PSS。
